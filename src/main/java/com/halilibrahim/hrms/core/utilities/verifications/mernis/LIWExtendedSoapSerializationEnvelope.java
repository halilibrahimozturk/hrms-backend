...
public class LIWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LIWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LIWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LIWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LIWDateTimeConverter dateTimeConverter = new LIWStandardDateTimeConverter();

    public LIWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LIWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LIWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LIWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (java.lang.Exception e)
        {
			if(enableLogging)
			{
//				android.util.Log.e(LIWExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LIWExtendedSoapSerializationEnvelope.class);
...
//						android.util.Log.e(LIWExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LIWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
